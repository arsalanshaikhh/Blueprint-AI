...
Users can now provide their own OpenRouter API key to use AI features in Blueprint AI. This feature is **only available to authenticated users** (signed in with Clerk).
...
Users can now sign in and provide their own OpenRouter API key to use all AI features in Blueprint AI.
