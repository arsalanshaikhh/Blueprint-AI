...
const docSections: DocSection[] = [
  {
    ...
    icon: Rocket,
    content: `# Getting Started with Blueprint AI

## What is Blueprint AI?

Blueprint AI is an AI-powered product planning and design tool that helps you define your product vision, generate data models and design systems, and export production-ready components.
...
Blueprint AI uses OpenAI's GPT-4 to generate:
      ...
      <div className="space-y-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-stone-600 dark:text-stone-400">
            Learn how to use Blueprint AI to plan and design your product
          </p>
        </div>
