...
- `blueprint_user_openrouter_api_key` - API key
- `blueprint_user_model_preference` - Model ID

### Data Format:

```typescript
// API Key
localStorage.setItem('blueprint_user_openrouter_api_key', 'sk-or-v1-...')

// Model Preference
localStorage.setItem('blueprint_user_model_preference', 'anthropic/claude-3.5-sonnet')
```
